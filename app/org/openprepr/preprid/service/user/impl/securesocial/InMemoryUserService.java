 ...
 *
 */
package org.openprepr.preprid.service.user.impl.securesocial;
...
public class InMemoryUserService extends BaseUserService<DemoUser> {
    public Logger.ALogger logger = play.Logger.of(InMemoryUserService.class);
